...
$sql = "SELECT * FROM merida WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE merida SET equipo = '$equipo', camaras = '$camaras', observaciones_camaras = '$observaciones_camaras', porcentaje_camaras = '$porcentaje_camaras', redes = '$redes', observaciones_redes = '$observaciones_redes', porcentaje_redes = '$porcentaje_redes' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../mostrar/cedisMerida.php");
        exit;
    } else {
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="../mostrar/cedisMerida.php">
