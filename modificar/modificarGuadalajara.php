...
$sql = "SELECT * FROM guadalajara WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE guadalajara SET clave = '$clave', area = '$area', equipo = '$equipo', marca = '$marca', modelo = '$modelo', especificaciones = '$especificaciones', observaciones_equipo = '$observaciones_equipo', estado = '$estado', observaciones_teclado = '$observaciones_teclado', porcentaje_teclado = '$porcentaje_teclado', observaciones_mouse = '$observaciones_mouse', porcentaje_mouse = '$porcentaje_mouse', observaciones_pantalla = '$observaciones_pantalla', porcentaje_pantalla = '$porcentaje_pantalla', observaciones_nobreak = '$observaciones_nobreak', porcentaje_nobreak = '$porcentaje_nobreak' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../mostrar/cedisGuadalajara.php");
        exit;
    } else {
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="../mostrar/cedisGuadalajara.php">
...
<body>
    ...
    <div class="container col-8 mt-5"><br>
        <h1 class="display-6">Modificar Cedis Guadalajara</h1>
