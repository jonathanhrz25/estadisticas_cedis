...
$sql = "SELECT * FROM oaxaca WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE oaxaca SET equipo = '$equipo', camaras = '$camaras', observaciones_camaras = '$observaciones_camaras', porcentaje_camaras = '$porcentaje_camaras', redes = '$redes', observaciones_redes = '$observaciones_redes', porcentaje_redes = '$porcentaje_redes' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../mostrar/cedisOaxaca.php");
        exit;
    } else {
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="../mostrar/cedisOaxaca.php">
...
<body>
    ...
    <div class="container col-8 mt-5"><br>
        <h1 class="display-6">Modificar Cedis Oaxaca</h1>
