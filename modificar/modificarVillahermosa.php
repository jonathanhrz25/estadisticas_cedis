...
<body>
    ...
    <div class="container col-8 mt-5"><br>
        ...
        <div class="form-group mb-3">
            ...
            <div class="form-group">
                <label for="porcentaje_equipo">Porcentaje Equipo:</label>
                <input type="text" class="form-control" name="porcentaje_equipo" value="<?php echo $mostrar['porcentaje_equipo']; ?>">
            </div>
