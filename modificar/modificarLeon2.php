...
$sql = "SELECT * FROM leon WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE leon SET equipo = '$equipo', camaras = '$camaras', observaciones_camaras = '$observaciones_camaras', porcentaje_camaras = '$porcentaje_camaras', redes = '$redes', observaciones_redes = '$observaciones_redes', porcentaje_redes = '$porcentaje_redes' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../mostrar/cedisLeon.php");
        exit;
    } else {
...
<body>
    ...
    <div class="container col-8 mt-5"><br>
        <h1 class="display-6">Modificar Cedis Leon</h1>
            ...
            <div class="form-group">
                <label for="tipo_equipo" class="form-label" name="tipo_equipo">Tipo de Equipo: </label><br>
                    <select class="form-control" id="tipo_equipo" name="tipo_equipo">
                        ...
                        <option value="PC ESCRITORIO" <?php if ($mostrar['tipo_equipo'] == "PC ESCRITORIO") echo "selected"; ?>>PC ESCRITORIO</option>
                        <option value="MONITOR" <?php if ($mostrar['tipo_equipo'] == "MONITOR") echo "selected"; ?>>Monitor</option>
                        <option value="IMPRESORA" <?php if ($mostrar['tipo_equipo'] == "IMPRESORA") echo "selected"; ?>>Impresora</option>
                        <option value="HAND HELD" <?php if ($mostrar['tipo_equipo'] == "HAND HELD") echo "selected"; ?>>Hand Held</option>
                        <option value="PANTALLA" <?php if ($mostrar['tipo_equipo'] == "PANTALLA") echo "selected"; ?>>Pantalla</option>
                        <option value="LAPTOP" <?php if ($mostrar['tipo_equipo'] == "LAPTOP") echo "selected"; ?>>Laptop</option>
                        <option value="NOBREAK" <?php if ($mostrar['tipo_equipo'] == "NOBREAK") echo "selected"; ?>>NoBreak</option>
                        <option value="SWITCH O ACCESS POINT" <?php if ($mostrar['tipo_equipo'] == "SWITCH") echo "selected"; ?>>Switch o Access Point</option>
                        <option value="DISCO DURO EXTERNO" <?php if ($mostrar['tipo_equipo'] == "DISCO DURO EXTERNO") echo "selected"; ?>>Disco duro externo</option>
                        <option value="CAMARAS" <?php if ($mostrar['tipo_equipo'] == "CAMARAS") echo "selected"; ?>>Camaras</option>
                        <option value="REDES" <?php if ($mostrar['tipo_equipo'] == "REDES") echo "selected"; ?>>Redes</option>
                    </select>
                </label>
            </div>
