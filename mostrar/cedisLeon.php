                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="text-center icon-cell">
                                <?php if ($_SESSION['rol'] === 'TI'): ?>
                                    <a href="../modificar/modificarLeon2.php?id=<?php echo $mostrar['Id']; ?>">
                                        <i class="fa fa-pencil-square-o fa-2x"></i>
                                    </a>
                                <?php else: ?>
                                    <i class="fa fa-pencil-square-o fa-2x text-muted"></i> <!-- Ícono deshabilitado -->
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.success) {
                        ...
                        window.location.href = "../modificar/modificarLeon.php?id=" + id; // Redirigir a la página de modificación
                    } else {
