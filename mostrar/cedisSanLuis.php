...
<body>
    <div style="padding-top: 40px;">
        ...
        <h1 class="display-6" style="color:black">Cedis San Luis Potosí</h1>
                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="text-center icon-cell">
                                <?php if ($_SESSION['rol'] === 'TI'): ?>
                                    <a href="../modificar/modificarSanLuis2.php?id=<?php echo $mostrar['Id']; ?>">
                                        <i class="fa fa-pencil-square-o fa-2x"></i>
                                    </a>
                                <?php else: ?>
                                    <i class="fa fa-pencil-square-o fa-2x text-muted"></i> <!-- Ícono deshabilitado -->
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.success) {
                        ...
                        window.location.href = "../modificar/modificarSanLuis.php?id=" + id; // Redirigir a la página de modificación
                    } else {
