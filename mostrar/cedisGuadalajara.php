                ...
                <tbody>
                    ...
                    while ($mostrar = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td class="text-center icon-cell">
                                <?php if ($_SESSION['rol'] === 'TI'): ?>
                                    <a href="../modificar/modificarGuadalajara2.php?id=<?php echo $mostrar['Id']; ?>">
                                        <i class="fa fa-pencil-square-o fa-2x"></i>
                                    </a>
                                <?php else: ?>
                                    <i class="fa fa-pencil-square-o fa-2x text-muted"></i> <!-- Ícono deshabilitado -->
...
<script>
    $(document).ready(function () {
        ...
        $('.modify-notification').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.success) {
                        // Si la actualización fue exitosa, redirigir a la página de modificación
                        window.location.href = "../modificar/modificarGuadalajara.php?id=" + id; // Redirigir a la página de modificación
                    } else {
        ...
        // Asegurarse de que el botón de eliminar comentario esté habilitado al regresar a cedisPachuca.php
