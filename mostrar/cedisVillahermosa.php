...
<div style="padding-top: 40px;">
    ...
    <h1 class="display-6">Cedis Villahermosa</h1>
            ...
            <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td class="text-center icon-cell">
                            <?php if ($_SESSION['rol'] === 'TI'): ?>
                                <a href="../modificar/modificarVillahermosa2.php?id=<?php echo $mostrar['Id']; ?>">
                                    <i class="fa fa-pencil-square-o fa-2x"></i>
                                </a>
                            <?php else: ?>
                                <i class="fa fa-pencil-square-o fa-2x text-muted"></i> <!-- Ícono deshabilitado -->
        ...
        $('.modify-notification').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.success) {
                        window.location.href = "../modificar/modificarVillahermosa.php?id=" + id;
                    } else {
