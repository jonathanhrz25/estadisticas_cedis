...
<body>
    <div style="padding-top: 40px;">
            ...
            <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
                <div class="container-fluid">
                    ...
                    <?php if ($_SESSION['rol'] === 'TI'): ?>
                        <a class="btn btn-success ml-2" href="../formulario/form_pachuca.php">Añadir</a>
                    <?php endif; ?>
        ...
        <h1 class="display-6" style="color:black">Cedis Pachuca</h1>
                ...
                <tbody>
                    ...
                    while ($mostrar = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td class="text-center icon-cell">
                                <?php if ($_SESSION['rol'] === 'TI'): ?>
                                    <a href="../modificar/modificarPachuca2.php?id=<?php echo $mostrar['Id']; ?>">
                                        <i class="fa fa-pencil-square-o fa-2x"></i>
                                    </a>
                                <?php else: ?>
                                    <i class="fa fa-pencil-square-o fa-2x text-muted"></i> <!-- Ícono deshabilitado -->
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.success) {
                        ...
                        window.location.href = "../modificar/modificarPachuca.php?id=" + id; // Redirigir a la página de modificación
                    } else {
