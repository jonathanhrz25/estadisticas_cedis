...
// Recopilar datos del formulario - Guadalajara
$clave = $_POST['clave'];
$area = $_POST['area'];
$equipo = $_POST['equipo'];
$marca = $_POST['marca'];
...
// Insertar datos en la tabla 'formulario Guadalajara'
$sql = "INSERT INTO guadalajara (clave, area, equipo, marca, modelo, especificaciones, observaciones_equipo, porcentaje_equipo, observaciones_teclado, porcentaje_teclado, observaciones_mouse, porcentaje_mouse, observaciones_pantalla, porcentaje_pantalla, observaciones_nobreak, porcentaje_nobreak, camaras, observaciones_camaras, porcentaje_camaras, redes, observaciones_redes, porcentaje_redes)
...
if ($insertar == true) {
    echo "<script> alert('Sus datos han sido registrados');
            window.location ='../mostrar/cedisGuadalajara.php';</script>";
} else {
    echo "<script> alert('ERROR sus datos NO han sido registrados');
  window.location ='../formulario/form_guadalajara.php';</script>";
}
