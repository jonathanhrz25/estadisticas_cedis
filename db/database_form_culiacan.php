...
// Recopilar datos del formulario - Culiacan
$clave = $_POST['clave'];
$area = $_POST['area'];
...
// Insertar datos en la tabla 'formulario Culiacan'
$sql = "INSERT INTO culiacan (clave, area, tipo_equipo, marca, modelo, especificaciones, observaciones_equipo, porcentaje_equipo, teclado, observaciones_teclado, porcentaje_teclado, mouse, observaciones_mouse, porcentaje_mouse, pantalla, observaciones_pantalla, porcentaje_pantalla, nobreak, observaciones_nobreak, porcentaje_nobreak, camaras, observaciones_camaras, porcentaje_camaras, redes, observaciones_redes, porcentaje_redes)
    VALUES ('$clave', '$area', '$tipo_equipo', '$marca', '$modelo', '$especificaciones', '$observaciones_equipo', '$porcentaje_equipo', '$teclado', '$observaciones_teclado', '$porcentaje_teclado', '$mouse', '$observaciones_mouse', '$porcentaje_mouse', '$pantalla', '$observaciones_pantalla', '$porcentaje_pantalla', '$nobreak', '$observaciones_nobreak', '$porcentaje_nobreak', '$camaras', '$observaciones_camaras', '$porcentaje_camaras', '$redes', '$observaciones_redes', '$porcentaje_redes')";
$insertar = mysqli_query($conn, $sql);

if ($insertar == true) {
    echo "<script> alert('Sus datos han sido registrados');
            window.location ='../mostrar/cedisCuliacan.php';</script>";
} else {
    echo "<script> alert('ERROR sus datos NO han sido registrados');
  window.location ='../formulario/form_culiacan.php';</script>";
}
