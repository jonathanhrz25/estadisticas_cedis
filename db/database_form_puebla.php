...
// Recopilar datos del formulario - Puebla
$clave = $_POST['clave'];
$area = $_POST['area'];
$equipo = $_POST['equipo'];
$marca = $_POST['marca'];
...
if ($insertar == true) {
    echo "<script> alert('Sus datos han sido registrados');
            window.location ='../mostrar/cedisPuebla.php';</script>";
} else {
    echo "<script> alert('ERROR sus datos NO han sido registrados');
  window.location ='../formulario/form_puebla.php';</script>";
}
