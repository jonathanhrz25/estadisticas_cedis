...
// Recopilar datos del formulario - San Luis
$clave = $_POST['clave'];
$area = $_POST['area'];
$equipo = $_POST['equipo'];
$marca = $_POST['marca'];
...
if ($insertar == true) {
    echo "<script> alert('Sus datos han sido registrados');
            window.location ='../mostrar/cedisSanLuis.php';</script>";
} else {
    echo "<script> alert('ERROR sus datos NO han sido registrados');
  window.location ='../formulario/form_SanLuis.php';</script>";
}
