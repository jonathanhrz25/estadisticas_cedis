...
// Recopilar datos del formulario - Veracruz
$clave = $_POST['clave'];
$area = $_POST['area'];
$equipo = $_POST['tipo_equipo'];
$marca = $_POST['marca'];
$modelo = $_POST['modelo'];
...
if ($insertar == true) {
    echo "<script> alert('Sus datos han sido registrados');
            window.location ='../mostrar/cedisVeracruz.php';</script>";
} else {
    echo "<script> alert('ERROR sus datos NO han sido registrados');
  window.location ='../formulario/form_veracruz.php';</script>";
}
