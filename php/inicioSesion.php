<?php
session_name('Cedis'); // Mantiene el mismo nombre de sesión
session_start();
require 'connect.php';
...
<body>
  <div class="content-wrapper">
    <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_jcikwtux.json" background="transparent" speed="2"
